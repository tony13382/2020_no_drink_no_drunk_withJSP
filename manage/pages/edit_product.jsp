                        ...
                        <div class="block_row">
                            <form action="edit_product_submit.jsp">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="GoodsName" class="form-control" placeholder="<%=gd.getString(1)%>" value="<%=gd.getString(1)%>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="Stock" class="form-control" min="0"
                                            placeholder="<%=gd.getString(3)%>" value="<%=gd.getString(3)%>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-2 col-form-label align-middle">產區</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="Made_Area" class="form-control" placeholder="<%=gd.getString(4)%>" value="<%=gd.getString(4)%>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-2 col-form-label align-middle">適合溫度</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="temperature" class="form-control" placeholder="<%=gd.getString(5)%>" value="<%=gd.getString(5)%>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-2 col-form-label align-middle">酒精濃度</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="density" class="form-control" placeholder="<%=gd.getString(6)%>" value="<%=gd.getString(6)%>" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-2 col-form-label align-middle">醒酒時間</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="wake_time" class="form-control" placeholder="<%=gd.getString(7)%>" value="<%=gd.getString(7)%>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="staticEmail"
                                        class="col-sm-2 col-form-label align-middle">價格</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="link_page" placeholder="<%=gd.getString(8)%>" value="<%=gd.getString(8)%>">
                                        <small id="emailHelp"
								 ...
								 <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="link_page" placeholder="<%=gd.getString(9)%>" value="<%=gd.getString(9)%>">
                                        <small id="emailHelp"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="link_photo" placeholder="<%=gd.getString(10)%>" value="<%=gd.getString(10)%>">
                                        <small id="emailHelp"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="GoodsID" readonly class="form-control" value="<%=gd.getString(11)%>" value="<%=gd.getString(11)%>">
                                    </div>
                                </div>
